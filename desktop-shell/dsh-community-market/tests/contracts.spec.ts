...
describe('package integration contract', () => {
  it('loads the Client through the official settings, sidebar, and shell features', () => {
    ...
    expect(manifest.peerDependencies).toHaveProperty('@deepseek-ai/dsh-client-ui-renderer', '0.1.2-rc.1')
    expect(manifest.peerDependencies).toHaveProperty('@deepseek-ai/dsh-client-ui-session', '0.1.2-rc.1')
    ...
    expect(manifest.peerDependencies).toHaveProperty('@deepseek-ai/dsh-client-ui-workspace', '0.1.2-rc.1')
  })
})
