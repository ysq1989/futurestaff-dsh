...
| @deepseek-ai/dsh | 0.1.2-rc.1 | MIT |
| @deepseek-ai/dsh-acp | 0.1.2-rc.1 | MIT |
| @deepseek-ai/dsh-acp-app | 0.1.2-rc.1 | MIT |
...
| @deepseek-ai/dsh-agent-tool-presentation | 0.1.2-rc.1 | MIT |
...
| @deepseek-ai/dsh-client-ui-primitives | 0.1.2-rc.1 | MIT |
...
| @deepseek-ai/dsh-client-ui-slots | 0.1.2-rc.1 | MIT |
...
| @deepseek-ai/dsh-headless | 0.1.2-rc.1 | MIT |
| @deepseek-ai/dsh-home-paths | 0.1.2-rc.1 | MIT |
| @deepseek-ai/dsh-hook-protocol | 0.1.2-rc.1 | MIT |
| @deepseek-ai/dsh-hooks-claude-code | 0.1.2-rc.1 | MIT |
| @deepseek-ai/dsh-hooks-codex | 0.1.2-rc.1 | MIT |
...
| @deepseek-ai/dsh-mcp-client | 0.1.2-rc.1 | MIT |
...
| @deepseek-ai/dsh-persona | 0.1.2-rc.1 | MIT |
...
| @deepseek-ai/dsh-sdk-app | 0.1.2-rc.1 | MIT |
| @deepseek-ai/dsh-sdk-jsonrpc-server | 0.1.2-rc.1 | MIT |
| @deepseek-ai/dsh-sdk-minimal | 0.1.2-rc.1 | MIT |
| @deepseek-ai/dsh-sdk-protocol | 0.1.2-rc.1 | MIT |
...
| @deepseek-ai/dsh-terminal | 0.1.2-rc.1 | MIT |
| @deepseek-ai/dsh-terminal-bash | 0.1.2-rc.1 | MIT |
| @deepseek-ai/dsh-time-context | 0.1.2-rc.1 | MIT |
| @deepseek-ai/dsh-timeout | 0.1.2-rc.1 | MIT |
| @deepseek-ai/dsh-tmux-context | 0.1.2-rc.1 | MIT |
...
| @deepseek-ai/dsh-tool-bash-persistent | 0.1.2-rc.1 | MIT |
| @deepseek-ai/dsh-tool-call-timeout-policy | 0.1.2-rc.1 | MIT |
| @deepseek-ai/dsh-tool-cordis | 0.1.2-rc.1 | MIT |
...
| @deepseek-ai/dsh-tool-pwsh-persistent | 0.1.2-rc.1 | MIT |
...
| @deepseek-ai/dsh-webhook | 0.1.2-rc.1 | MIT |
| @deepseek-ai/dsh-webhook-github | 0.1.2-rc.1 | MIT |
...
| @earendil-works/pi-ai | 0.84.3 | MIT |
| @earendil-works/pi-telemetry | 0.84.3 | MIT |
