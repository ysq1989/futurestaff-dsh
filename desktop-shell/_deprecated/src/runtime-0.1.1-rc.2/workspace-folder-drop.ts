...
/** Stable renderer-owned slot anchor followed by the Workspace surface root. */
export const WORKSPACE_DROP_TARGET = '[data-slot="sidebar.workspaces"] > *'
...
export function installWorkspaceFolderDrop(
  ...
  style.dataset.pluginCss = 'dsh-plugin-desktop/workspace-folder-drop'
