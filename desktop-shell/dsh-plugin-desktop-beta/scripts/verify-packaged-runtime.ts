...
export const REQUIRED_UNPACKED_PACKAGE_SPECIFIERS = [
  ...
  'dsh-plugin-desktop-beta/client',
  'dsh-plugin-desktop-beta/terminal',
  'dsh-plugin-desktop-beta/pnpm',
  'dsh-plugin-desktop-beta/profile-service',
  'dsh-plugin-desktop-beta/profiles',
  'dsh-plugin-desktop-beta/diagnostics',
  'dsh-plugin-desktop-beta/notifications',
  'dsh-plugin-desktop-beta/updates',
  'dsh-plugin-desktop-beta/windows-pwsh-sandbox',
