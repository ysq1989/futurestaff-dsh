...
- [x] [spark] Repair the pinned DSH `profile:dump` launcher dependency resolution; completed in B01b with repository-pinned DSH `0.1.2-rc.1` aligned to the desktop shell.
